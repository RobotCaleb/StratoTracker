...
(function() {
  var TCP, UDP, aprsCollection, aprsIO, aprsparser, auth, blogCollection, blogIO, broadcastBlog, callsignFilter, db, dgram, env, envFile, express, form, fs, im, insertCallback, io, localSettingsFile, logEntry, mongojs, net, parser, path, processAPRSPacket, processDecodedAPRSPacket, saveImageData, sendInitialAPRS, sendInitialBlogs, server, settings, udpPort, webroot;
  ...
  processAPRSPacket = function(packet) {
    ...
    if (msg.indexOf(callsignFilter) === 0) {
      return parser.decode(msg, function(packet) {
